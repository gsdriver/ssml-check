...
promises.push(runTest('Invalid tag with element in second position', '<speak><break time="100ms"/><break time="20000ms"/><tag>What is this?</tag>This &amp; that</speak>', {getPositions: true}, 'at position 28 break tag has invalid time value 20000msat position 51 tag tag has invalid '));
